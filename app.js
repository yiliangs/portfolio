...
'use strict';
  ...
  class Component extends DCLogic {
    ...
    data = [
      ...
      { title: 'Timber Index', subtitle: 'A side project cataloguing mass-timber connections, one joint at a time.', kind: 'Side project', year: 2023, page: 170, pages: '170–177', role: 'Everything', with: 'Contributors, eventually', status: 'Live, growing slowly', statusShort: 'live', stack: 'A static site, hand-drawn axonometrics, a spreadsheet as the database.', link: 'The index, 212 joints and counting', caption: 'Joint 087: a CLT-to-glulam hanger, drawn at 1:5.', placeholder: 'Capture: axonometric of a timber joint',
      ...
      { id: 'the-eyeball-line', title: 'The Eyeball Line', subtitle: 'AI pricing is converging on one rule: inference a human watches gets subsidized, inference nobody watches gets metered.', kind: 'Essay', year: 2026, page: 188, pages: '188–193', role: 'Author', with: 'A solo piece', status: 'Published, June 2026', statusShort: 'published', stack: 'Prose; first published on Substack on 10 June 2026, with a drawing made for it.', link: 'The post on Substack', href: 'https://yiliangs.substack.com/p/the-eyeball-line', linkBlank: true, caption: 'A hall of machines at desks, each on its own meter; the one a man sits watching works in the beam of an eye overhead.', placeholder: 'Plate: cover image',
      ...
      { title: 'On drawing with machines', subtitle: 'An essay on what changes when software starts to propose, not just record.', kind: 'Writing', year: 2025, page: 194, pages: '194–201', role: 'Author', with: 'A patient editor', status: 'Published', statusShort: 'published', stack: 'A text editor, three drafts, a walk between each.', link: 'Read the essay', caption: 'A sketch from the essay: the same room, drawn by hand and by suggestion.', placeholder: 'Plate: hand sketch beside a machine proposal',
    ...
    pages = {
      writing: { reg: 'serif', label: 'Research', kicker: 'Essays · Research', bio: 'I write about what happens when machines start drawing too, and I publish the research that keeps me honest. The tools live next door, in mono.', title: 'Drawings, tools, and other arguments.', byline: 'by Yiliang Shao', edition: 'Edition of one', stamp: 'MMXXVI',
        ...
        indexKicker: 'Contents', indexTitle: 'Seven chapters, hover to preview.', indexNote: 'Page numbers follow the bound edition. Chapters marked Research link to the published paper; the rest are written here in full.',
