...
'use strict';
  ...
  class Component extends DCLogic {
    ...
    data = [
      ...
      { id: 'the-eyeball-line', title: 'The Eyeball Line', subtitle: 'AI pricing is converging on one rule: inference a human watches gets subsidized, inference nobody watches gets metered.', kind: 'Essay', year: 2026, page: 200, pages: '200–205', role: 'Author', with: 'A solo piece', status: 'Published, June 2026', statusShort: 'published', stack: 'Prose; first published on Substack on 10 June 2026, with a drawing made for it.', link: 'The post on Substack', href: 'https://yiliangs.substack.com/p/the-eyeball-line', linkBlank: true, caption: 'A hall of machines at desks, each on its own meter; the one a man sits watching works in the beam of an eye overhead.', placeholder: 'Plate: cover image',
