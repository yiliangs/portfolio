      ...
      h("div", { key: "0", ref: V.rootRef, style: S(`position:relative; min-height:100vh; background:var(--color-bg); color:var(--color-text);  font-family:var(--r-body); font-size:17px; line-height:28px; --mono:'Geist Mono', ui-monospace, monospace; --sig-ok:#6cc48a; --sig-warn:#e0b04f; --sig-info:#79aed1; --font-heading:'Newsreader', 'Cormorant Garamond', Georgia, serif; --deco:'Cinzel', 'Cormorant Garamond', serif; --r-body:${V.rBody ?? ""}; --r-align:${V.rAlign ?? ""}; --r-tracking:${V.rTracking ?? ""}; --color-bg:${V.tBg ?? ""}; --color-surface:${V.tSurface ?? ""}; --color-text:${V.tText ?? ""}; --color-accent:${V.tAccent ?? ""}; --color-accent-600:${V.tAccent600 ?? ""}; --color-accent-700:${V.tAccent700 ?? ""}; --color-accent-800:${V.tAccent800 ?? ""}; --color-accent-100:${V.tAccent100 ?? ""}; --color-divider:${V.tDivider ?? ""}; --color-neutral-100:${V.tN100 ?? ""}; --color-neutral-400:${V.tN400 ?? ""}; --color-neutral-500:${V.tN500 ?? ""}; --color-neutral-600:${V.tN600 ?? ""}; --color-neutral-700:${V.tN700 ?? ""}; --color-neutral-800:${V.tN800 ?? ""};`) },
        ...
        (V.isHome ? h(F,{key:12},
          ...
          h("main", { key: "home", "data-screen-label": "Home", style: {"padding":"0 clamp(20px,5vw,72px)","minHeight":"calc(100vh - 57px)","boxSizing":"border-box","display":"grid","gridTemplateRows":"auto minmax(0,1fr) auto"} },
            ...
            "\n    ",
            h("p", { key: "5|66.a0tral", ref: V.homeFootRef, style: {"margin":"0","padding":"0 0 clamp(18px,4vh,40px)","display":"flex","justifyContent":"center","gap":"24px","fontFamily":"var(--mono)","fontSize":"11px","letterSpacing":"0.08em","color":"var(--color-neutral-600)"} },
              h("span", { key: "0|4.yjzzeq" },
                "Oslo"
              ),
              h("span", { key: "1|17.sodc1e" },
                "hello@example.com"
              ),
            ...
            h("section", { key: "2", ref: V.heroRef, style: {"position":"relative","textAlign":"center","margin":"0 calc(-1 * clamp(20px,3vw,56px))","padding":"28px clamp(20px,3vw,56px) 96px","perspective":"1200px","overflow":"hidden","height":"calc(100vh - 57px)","boxSizing":"border-box","display":"grid","gridTemplateColumns":"minmax(280px,1fr) minmax(0,900px) minmax(280px,1fr)","gap":"0 40px","alignItems":"center"} },
              ...
              h("nav", { key: "8|149.f5ogm5", "aria-label": "Contact", style: {"position":"absolute","left":"50%","bottom":"24px","transform":"translateX(-50%)","zIndex":"3","width":"min(360px, 30vw)","height":"44px","fontFamily":"var(--font-heading)","fontSize":"14px","lineHeight":"20px"} },
                ...
                h("span", { key: "5|76.76j6gw", style: {"position":"absolute","inset":"0","display":"flex","alignItems":"center","justifyContent":"center","gap":"clamp(20px, 3vw, 44px)"} },
                  "\n          ",
                  h("a", { key: "1|5.3mzikt", href: "mailto:hello@example.com", style: {"color":"var(--color-accent)","textDecoration":"none","letterSpacing":"0.06em","display":"flex","alignItems":"center","lineHeight":"1","transition":"color 200ms ease, letter-spacing 200ms ease"}, className: "scp4" },
                    "Email"
                  ),
                  "\n          ",
                  h("a", { key: "3|6.1e9lseg", href: "#", style: {"color":"var(--color-accent)","textDecoration":"none","letterSpacing":"0.06em","display":"flex","alignItems":"center","lineHeight":"1","transition":"color 200ms ease, letter-spacing 200ms ease"}, className: "scp4" },
                    "GitHub"
                  ),
                  "\n          ",
                  h("a", { key: "5|2.3hnb2", href: "#", style: {"color":"var(--color-accent)","textDecoration":"none","letterSpacing":"0.06em","display":"flex","alignItems":"center","lineHeight":"1","transition":"color 200ms ease, letter-spacing 200ms ease"}, className: "scp4" },
                    "CV"
                  ),
                  "\n        "
                ),
