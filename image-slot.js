...
(() => {
  ...
  const stylesheet =
    ...
    // touch-action:none only while reframing (local change to the starter): on the whole time it
    // made a touch that began on a picture unable to scroll the page, which on a phone is most of
    // a landing page. Panning in reframe mode originates on the spill layer anyway.
