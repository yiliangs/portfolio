...
const TUNED = {
  left: [
      ...
      { row: '2', col: '1', selfY: 'center', selfX: 'start', imgH: 'min(35vh, 550px)', ratio: '1/1', maxW: '350px', titleSize: '17px', dir: 'column', alignItems: 'flex-start', align: 'left', px: '-14px', py: '-8px', dur: '8s', delay: '-5s', offsetX: '336.667px', offsetY: '112px', bleedX: '0px', bleedY: '0px' },
      ...
      { row: '2', col: '2', selfY: 'center', selfX: 'end', imgH: 'min(15.077vh, 239.688px)', ratio: '4/5', maxW: '148.452px', titleSize: '15px', dir: 'column', alignItems: 'flex-end', align: 'left', px: '-17px', py: '-12px', dur: '7.8s', delay: '-6s', offsetX: '-478px', offsetY: '149.333px', bleedX: '0px', bleedY: '0px' },
  ],
  right: [
      { row: '2', col: '1 / 3', selfY: 'center', selfX: 'end', imgH: 'min(54.977vh, 824.659px)', ratio: '3/4', maxW: '641.402px', titleSize: '26px', dir: 'row-reverse', alignItems: 'flex-end', align: 'right', px: '-26px', py: '-14px', dur: '9s', delay: '-3s', offsetX: '11.333px', offsetY: '23.334px', bleedX: '0px', bleedY: '0px' },
      { row: '1', col: '1 / 3', selfY: 'start', selfX: 'end', imgH: 'min(22.823vh, 329.662px)', ratio: '3/2', maxW: '342.341px', titleSize: '17px', dir: 'row-reverse', alignItems: 'flex-start', align: 'right', px: '-22px', py: '-12px', dur: '10s', delay: '-1.5s', offsetX: '-512.667px', offsetY: '-36.667px', bleedX: '0px', bleedY: '0px', stackH: 'min(16.483vh, 152.152px)' },
      { row: '3', col: '2', selfY: 'end', selfX: 'end', imgH: 'min(25.554vh, 408.869px)', ratio: '2/3', maxW: '170.362px', titleSize: '15px', dir: 'column', alignItems: 'flex-end', align: 'right', px: '-16px', py: '-11px', dur: '9.5s', delay: '-4s', offsetX: '-62.667px', offsetY: '-36.667px', bleedX: '0px', bleedY: '0px' },
